...
public class NewCustomer extends javax.swing.JFrame {
    ...
    public NewCustomer() {
        initComponents();
        Home.last_no(jLabel2, "SELECT customer_no FROM customer");
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new jdbc().putdata("INSERT INTO customer VALUES('"+jLabel2.getText()+"', '"+jTextField1.getText()+"', '"+jTextArea1.getText()+"', "
                + "'"+jTextField2.getText()+"')");
