...
public class NewSupplier extends javax.swing.JFrame {
    ...
    public NewSupplier() {
        initComponents();
        Home.last_no(jLabel2, "SELECT supplier_no FROM supplier");
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new jdbc().putdata("INSERT INTO supplier VALUES('"+jLabel2.getText()+"', '"+jTextField1.getText()+"', '"+jTextArea1.getText()+"', "
                + "'"+jTextField2.getText()+"')");
