...
public class NewInvoice extends javax.swing.JFrame {
    ...
    public NewInvoice() {
        initComponents();
        Home.last_no(jLabel3, "SELECT MAX(invoice_no) FROM invoice");
        AdvancedComboFilter.Filter(jComboBox2, "SELECT name FROM customer");
...
//        AdvancedComboFilter.Filter(jComboBox2, "SELECT batch_no FROM item WHERE name='"+jComboBox3.getSelectedItem().toString()+"'");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            new jdbc().putdata("INSERT INTO invoice VALUES('" + jLabel3.getText() + "','" + jTextField3.getText() + "','" + Home.date_format(new Date()) + "','" + lbl_due.getText() + "')");
            
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                new jdbc().putdata("INSERT INTO invoice_data VALUES('" + jLabel3.getText() + "','" + jTable1.getValueAt(i, 0) + "','" + jTable1.getValueAt(i, 2) + "',"
...
//        JOptionPane.showMessageDialog(this, "Fuck");
    ...
    private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox2ItemStateChanged
        try {
            ResultSet r = new jdbc().getdata("SELECT customer_no FROM customer WHERE name='"+jComboBox2.getSelectedItem().toString()+"'");
            if (r.next()) {
